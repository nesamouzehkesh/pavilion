...
angular.module('dynform', [])
  .directive('dynamicForm', ['$q', '$parse', '$http', '$templateCache', '$compile', '$document', '$timeout', function ($q, $parse, $http, $templateCache, $compile, $document, $timeout) {
    var supported = {
        //  Text-based elements
        'text': {element: 'input', type: 'text', class: 'form-control', editable: true, textBased: true},
        'date': {element: 'input', type: 'date', class: 'form-control', editable: true, textBased: true},
        'datetime': {element: 'input', type: 'datetime', class: 'form-control', editable: true, textBased: true},
        'datetime-local': {element: 'input', type: 'datetime-local', class: 'form-control', editable: true, textBased: true},
        'email': {element: 'input', type: 'email', class: 'form-control', editable: true, textBased: true},
        'month': {element: 'input', type: 'month', class: 'form-control', editable: true, textBased: true},
        'number': {element: 'input', type: 'number', class: 'form-control', editable: true, textBased: true},
        'password': {element: 'input', type: 'password', class: 'form-control', editable: true, textBased: true},
        'search': {element: 'input', type: 'search', class: 'form-control', editable: true, textBased: true},
        'tel': {element: 'input', type: 'tel', class: 'form-control', editable: true, textBased: true},
        'textarea': {element: 'textarea', class: 'form-control', editable: true, textBased: true},
        'time': {element: 'input', type: 'time', class: 'form-control', editable: true, textBased: true},
        'url': {element: 'input', type: 'url', class: 'form-control', editable: true, textBased: true},
        'week': {element: 'input', type: 'week', class: 'form-control', editable: true, textBased: true},
        //  Specialized editables
        'checkbox': {element: 'input', type: 'checkbox', class: '', editable: true, textBased: false},
        'color': {element: 'input', type: 'color', class: '', editable: true, textBased: false},
        ...
        'radio': {element: 'div', class: '', editable: false, textBased: false},
        //  Non-editables (mostly buttons)
        'button': {element: 'button', type: 'button', class: 'btn btn-primary', editable: false, textBased: false},
        'hidden': {element: 'input', type: 'hidden', class: '', editable: false, textBased: false},
        'image': {element: 'input', type: 'image', class: '', editable: false, textBased: false},
        'legend': {element: 'legend', class: '', editable: false, textBased: false},
        'reset': {element: 'button', type: 'reset', class: 'btn btn-primary', editable: false, textBased: false},
        'submit': {element: 'button', type: 'submit', class: 'btn btn-primary', editable: false, textBased: false}
      };
          ...
          (attrs.template ? $q.when($parse(attrs.template)($scope)) :
            ...
            buildFields = function (field, id) {
              if (String(id).charAt(0) == '$') {
                ...
                // Saman Update
                newElement.addClass(supported[field.type].class);
                // End of Saman Update
