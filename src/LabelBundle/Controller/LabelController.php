...
class LabelController extends BaseController
{
    ...
    public function displayLabelsAction()
    {
        ...
        return $this->render(
            'LabelBundle:Label:index.html.twig',
            array(
                'labels' => $labels
                )
            );
    ...
    public function addEditLabelAction(Request $request, $labelId = null)
    {
        ...
        return $this->render(
            'LabelBundle:Label:addEditLabel.html.twig', 
            array(
    ...
    private function getLabel($labelId = null)
    {
        ...
        if (null === $labelId) {
            ...
            $label = $em->getRepository('LabelBundle:Label')->find($labelId);
    ...
    private function getLabels()
    {
        ...
        // Get all Labels
        $labels = $em->getRepository('LabelBundle:Label')->findAll();
