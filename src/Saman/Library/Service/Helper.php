...
class Helper 
{
     ...
     * @return type
     */
    public function getJsonParamResponse(
        $success, 
        $responseParam, 
        $message = null 
        )
    {
        return $this->getJsonResponse($success, $message, null, $responseParam);
    }
    ...
    /**
     * Get not found exception response
     * 
     * @param type $itemId
     */
    public function getExceptionResponseNotFound($itemId)
    {
        return $this->getExceptionResponse(
            'alert.error.noItemHasBeenFound',
            array('%id%' => $itemId)
            );
    }
    
    /**
     * Get general exception json response message
     * 
     * @param type $messageId
     * @param type $messageParam
     * @return type
     */
    public function getExceptionResponse($messageId, $messageParam = array(), $ex = null)
    {
        $message = $this->trans($messageId, $messageParam);
        $response = $this->getJsonResponse(false, $message);
