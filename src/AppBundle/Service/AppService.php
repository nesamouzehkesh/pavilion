...
class AppService 
{
    ...
    /**
     * 
     * @param \MediaBundle\Service\MediaService $mediaService
    ...
    /**
     * 
     * @param \ConfigBundle\Service\ConfigService $configService
     * @return \Library\Service\Helper
     */
     ...
     * @param \Library\Service\User $user
     * @return type
     * @throws \Exception
     */
    ...
    private function deleteEntityAndAssociations($entity)
    {
        ...
        foreach ($reflectionProperties as $reflectionProperty) {
            $mediaAnnotation = $annotationReader->getPropertyAnnotation(
                $reflectionProperty, 
                'Library\\Annotation\\DeleteAnnotation'
                );
